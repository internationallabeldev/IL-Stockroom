...
export function ProducerDashboard({ userName }: { userName: string }) {
  ...
  return (
    <div className="px-8 pt-8 pb-16 space-y-8">
      <header>
        <h1 className="font-heading text-4xl font-bold tracking-tight text-[#1A1A1A]">Producción</h1>
      ...
      <div className="grid grid-cols-12 gap-4">
        <div className="col-span-6">
          <div className="bg-[#fdf9f0] border border-[#1A1A1A]/10 p-5">
            ...
            {reqsLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-8 gap-2">
                ...
                <p className="text-[9px] font-bold uppercase tracking-widest text-[#1A1A1A]/40">Sin requisiciones activas</p>
              </div>
            ) : (
              <div className="space-y-1">
                {reqs!.slice(0, 8).map(req => (
                  <div key={req.id} className="flex items-center gap-3 px-3 py-2.5 bg-[#E5E1D8]/30">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-[9px] text-[#1A1A1A]/40 mt-0.5">OT: {req.production_order}</p>
                    </div>
