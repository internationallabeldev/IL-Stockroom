                      ...
                      <button
                        ...
                        className={cn(
                          ...
                          materialType === t
                            ...
                            : 'text-[#1A1A1A]/50 hover:bg-[#E5E1D8]'
                        )}
                      >
                        {t === 'INK' ? 'Tintas' : 'Papel'}
                      </button>
                    ...
                    return (
                      <div key={field.id} className="border border-[#1A1A1A]/10 bg-[#fdf9f0] p-3 space-y-2">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <button type="button" onClick={() => removeInk(idx)} className="shrink-0 size-6 flex items-center justify-center text-[#1A1A1A]/40 hover:text-red-600 transition-colors">
                    ...
                    return (
                      <div key={field.id} className="border border-[#1A1A1A]/10 bg-[#fdf9f0] p-3 space-y-2">
                        <div className="flex items-start justify-between gap-2">
                          ...
                          <button type="button" onClick={() => removePaper(idx)} className="shrink-0 size-6 flex items-center justify-center text-[#1A1A1A]/40 hover:text-red-600 transition-colors">
                            <Trash2 className="size-3.5" />
                          </button>
                        </div>
          ...
          {items.length === 0
            ...
            : items.map(paper => (
              ...
              >
                ...
                {paper.weight_gsm && (
                  <span className="ml-auto text-[9px] text-[#5f5e59] shrink-0">{paper.weight_gsm} g/m²</span>
                )}
              </button>
            ))
          }
